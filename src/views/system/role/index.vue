  ...
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-container">
      ...
      >
        ...
        <el-table-column label="角色名称" prop="name" min-width="80" />
        <el-table-column label="角色备注" prop="code" width="250" />
    ...
    >
      ...
      >
        ...
        <el-form-item label="角色备注" prop="code">
          <el-input v-model="formData.code" placeholder="请输入角色备注" />
        </el-form-item>
